			...
			<Card className=" max-w-sm rounded-3xl ">
				<div className=" p-3">
									...
									<CarouselItem key={index}>
										<div className="p-1">
											<Card className=" bg-transparent border-none rounded-3xl">
												<CardContent className="flex aspect-[4/2.4] items-center justify-center p-6 rounded-3xl relative">
													<Badge
														variant="outline"
					...
					<div className=" py-3 space-y-3">
						...
						<div className=" flex gap-3 flex-col">
							...
							<span className=" text-sm ml-8 text-gray-500">
				...
				<div className=" p-3 pt-5">
					<div className=" flex justify-between">
						...
						<span className=" text-sm font-semibold">$XXX</span>
					</div>
